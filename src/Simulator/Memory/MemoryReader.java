...
public class MemoryReader implements Hardware {
    ...
    public MemoryReader(Memory memory, Wire w_address, Wire w_writeData, Wire w_readData, Wire control_MemWrite, Wire control_MemRead){
        this.memory = memory;
    ...
    public MemoryReader(Memory memory, Wire w_address,  Wire w_readData){
        this(memory, w_address, new Wire(), w_readData, new Wire(0b0), new Wire(0b1));
    }
